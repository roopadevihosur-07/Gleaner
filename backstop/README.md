...
When a federal or donated inbound load is **cut or short-shipped**, Gleaner turns
...
1. **Sense** — Gleaner detects the cut inbound load.
...
Toggle **Naive ↔ Gleaner** on the map to show the before/after route live.
...
- Gleaner is **genuinely agentic** (orchestrator → specialist tools → human gate),
